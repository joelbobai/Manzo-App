...
const SEARCH_API_URL = `${API_BASE_URL}/api/v1/flights/flightOffersSearch`;
const MULTI_CITY_SEARCH_API_URL = `${API_BASE_URL}/api/v1/flights/flightOffersSearchMultiCity`;
